    ...
    public class AutoMapper : Profile
    {
        public AutoMapper()
        {
            ...
            CreateMap<Booking, BookingViewModel>()
                ...
                .ForMember(dest => dest.ConsultantId, opt => opt.MapFrom(src => src.ConsultationTime.Day.Expert.Id))
                .ForMember(dest => dest.ConsultantName, opt => opt.MapFrom(src => src.ConsultationTime.Day.Expert.Name))
                .ForMember(dest => dest.ConsultantEmail, opt => opt.MapFrom(src => src.ConsultationTime.Day.Expert.Account.Email))
                .ForMember(dest => dest.ConsultantPhone, opt => opt.MapFrom(src => src.ConsultationTime.Day.Expert.Account.Phone))
